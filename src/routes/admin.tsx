...
import { LayoutGrid, Users, BookOpen, Calendar, Plus, Infinity as InfinityIcon, Trophy, Swords } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/arsenal", label: "Arsenal", icon: <Swords className="h-4 w-4" /> },
